...
#define BULLET_JASON_NORMAL_LV2_ANI_RIGHT				2
#define BULLET_JASON_NORMAL_LV2_ANI_TOP					3
#define BULLET_JASON_UPGRADE_ANI_RIGHT					4
#define BULLET_JASON_UPGRADE_ANI_TOP					5
#define BULLET_BANG										6

#define BULLET_JASON_DELAY								800
